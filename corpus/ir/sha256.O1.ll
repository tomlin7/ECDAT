...
for.body26:                                       ; preds = %for.body, %for.body26
  %indvars.iv232 = phi i64 [ %indvars.iv.next233, %for.body26 ], [ 16, %for.body ]
  %16 = add nsw i64 %indvars.iv232, -15
  %arrayidx28 = getelementptr inbounds [64 x i32], ptr %w, i64 0, i64 %16
  %17 = load i32, ptr %arrayidx28, align 4, !tbaa !8
  %or.i = tail call i32 @llvm.fshl.i32(i32 %17, i32 %17, i32 25)
  %or.i191 = tail call i32 @llvm.fshl.i32(i32 %17, i32 %17, i32 14)
  %xor = xor i32 %or.i, %or.i191
  %shr = lshr i32 %17, 3
  %xor36 = xor i32 %xor, %shr
  %18 = add nsw i64 %indvars.iv232, -2
  %arrayidx39 = getelementptr inbounds [64 x i32], ptr %w, i64 0, i64 %18
  %19 = load i32, ptr %arrayidx39, align 4, !tbaa !8
  %or.i194 = tail call i32 @llvm.fshl.i32(i32 %19, i32 %19, i32 15)
  %or.i197 = tail call i32 @llvm.fshl.i32(i32 %19, i32 %19, i32 13)
  %xor45 = xor i32 %or.i194, %or.i197
  %shr49 = lshr i32 %19, 10
  %xor50 = xor i32 %xor45, %shr49
  %20 = add nsw i64 %indvars.iv232, -16
  %arrayidx53 = getelementptr inbounds [64 x i32], ptr %w, i64 0, i64 %20
  %21 = load i32, ptr %arrayidx53, align 4, !tbaa !8
  %add54 = add i32 %xor36, %21
  %22 = add nsw i64 %indvars.iv232, -7
  %arrayidx57 = getelementptr inbounds [64 x i32], ptr %w, i64 0, i64 %22
  %23 = load i32, ptr %arrayidx57, align 4, !tbaa !8
  %add58 = add i32 %add54, %23
  ...
  br i1 %exitcond239.not, label %for.cond.cleanup25, label %for.body26, !llvm.loop !13
...
for.body78:                                       ; preds = %for.cond.cleanup25, %for.body78
  ...
  br i1 %exitcond243.not, label %for.cond.cleanup77, label %for.body78, !llvm.loop !14
}
