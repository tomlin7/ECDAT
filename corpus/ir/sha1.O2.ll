...
for.body26:                                       ; preds = %for.body, %for.body26
  ...
  br i1 %exitcond178.not, label %for.cond.cleanup25, label %for.body26, !llvm.loop !12
...
if.end78:                                         ; preds = %if.then62, %if.else74, %if.then68, %if.then
  ...
  br i1 %exitcond182.not, label %for.cond.cleanup54, label %for.body55, !llvm.loop !13
}
